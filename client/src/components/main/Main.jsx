      ...
      <div>
        <div className="main-top-img">
          <div className="main-top-text">
            <h2>아이스닥터 데모</h2>
            <p>점주와 기사님의 서비스 흐름을 직접 확인해보세요.</p>
            <div className="main-demo-actions">
              <button type="button" className="btn-medium bg-blue" onClick={() => navigate('/login')}>데모 로그인</button>
              <button type="button" className="btn-medium bg-white" onClick={() => navigate('/registration')}>회원가입 체험</button>
            </div>
      ...
      <div className="main-howto-service">
        ...
        <div className="main-howto-service-container">
          ...
          <div className="main-howto-service-step">
            ...
            <p>채팅을 통해 대화하며 자세한 조율 후 매칭됩니다.</p>
          </div>
          <div className="main-howto-service-arrow">▶</div>
          <div className="main-howto-service-step">
